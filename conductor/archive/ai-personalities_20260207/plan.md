...
## Phase 2: Combat Logic & Learning [checkpoint: dc1d4c7]
...
- [x] Task: Implement "Mastermind" Simulation. Create a physics-based shot simulator that iterates to find the perfect angle/power, refining its solution based on the previous shot's error. (Refined: Terrain awareness added)
