...
describe('Sudden Death Logic', () => {
    beforeEach(() => {
        ...
        state.tanks = [
            { alive: true, health: 100, maxHealth: 100, die: vi.fn(), x: 100, width: 20, y: 500, height: 10, name: 'P1' },
            { alive: true, health: 100, maxHealth: 100, die: vi.fn(), x: 500, width: 20, y: 500, height: 10, name: 'P2' }
        ];
    });
    ...
    it('should increment turn count and activate after startTurn', () => {
        ...
        // Sudden Death isResolving is true immediately
        expect(state.suddenDeath.isResolving).toBe(true);
